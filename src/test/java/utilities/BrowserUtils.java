...
public class BrowserUtils {
    ...
    public static void switchToWindow(String targetTitle) {
        String origin = utilities.Driver.get().getWindowHandle();
        for (String handle : utilities.Driver.get().getWindowHandles()) {
            utilities.Driver.get().switchTo().window(handle);
            if (utilities.Driver.get().getTitle().equals(targetTitle)) {
                return;
            }
        }
